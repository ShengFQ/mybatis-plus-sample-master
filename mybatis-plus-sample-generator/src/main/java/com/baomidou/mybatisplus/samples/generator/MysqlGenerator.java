...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://121.40.249.227:3306/zwow_iot?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        pc.setModuleName("zwow_iot");
        pc.setParent("com.geer2.zwow.iot.bonus");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return  "/mybatis-plus-sample-generator/src/main/resources/mapper/" + pc.getModuleName()
